...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "msPostsHatcc@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "msPostsHatcc API";

        private String description = "msPostsHatcc API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "msPostsHatcc";
